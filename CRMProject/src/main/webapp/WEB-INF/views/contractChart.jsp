...
<div id="contract_datagrid_bt">
    <div>
        <form id="contract_searchForm">
            ...
            <a class="easyui-linkbutton" iconCls="icon-search" data-cmd="searchContent">
                <span><font color="#c71585">查询</font></span>
            </a>

            <span><font color="#c71585">分组信息</font></span>:
            <select id="becometime_group_count" class="easyui-combobox" name="time" style="width:200px;">
            ...
            <select id="photo_group" class="easyui-combobox" name="photo" style="width:50px;height: 15px">
