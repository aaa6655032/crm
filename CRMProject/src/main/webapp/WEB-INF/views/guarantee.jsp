...
<body>
   ...
   <div id ="guarantee_linkbutton_dialog">
    ...
    <table align="center" style="margin-top: 20px">
     ...
     <tr>
     <td>质保到期时间</td>
      <td> <input name="duetime" class="easyui-datebox" required data-options="validType:'md[\'10/11/2012\']'" readonly="readonly"></input></td><!-- 日期格式 -->
     </tr>
     ...
     <td>保修客户</td>
      <td>    <input class="easyui-combobox" 
            name="customer.id"
            data-options="url:'customer_queryByName',valueField:'id',textField:'name'" readonly="readonly"></td><!--下拉框  -->
     </tr>
    </table>
    </form>
   </div>
   ...
   <div id ="guaranteeItem_dialog">
    ...
    <table align="center" style="margin-top: 25px">
      ...
      <tr>
       <td>保修时间</td>
       <td> <input name ="guaranteetime" class="easyui-datebox" required data-options="validType:'md[\'10/11/2012\']'"></input></td>
      </tr>
