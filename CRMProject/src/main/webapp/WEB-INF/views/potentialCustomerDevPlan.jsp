...
<html>
<head>
    <title>潜在客户开发计划管理</title>
    <%@ include file="common.jsp" %>
    <script type="text/javascript" src="/js/views/potentialCustomerDevPlan.js"></script>
</head>
<body>
<table id="potentialCustomerDevPlan_datagrid"></table>
<div id="potentialCustomerDevPlan_datagrid_btn">
    <div>
    ...
    <div>
        <form id="potentialCustomerDevPlan_searchForm">
...
<div id="potentialCustomerDevPlan_dialog">
    <form id="potentialCustomerDevPlan_dialog_form" method="post">
        <input type="hidden" name="id"/>
        <table align="center">
            <tr>
                <td>客户选择</td>
                <td><select name="customer.id" id="potentialCustomerDevPlan_select_combogrid"
    ...
    <div id="potentialCustomerDevPlan_dialog_bb">
