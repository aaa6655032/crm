...
<div id="tb">
    ...
    <a class="easyui-linkbutton" data-options="iconCls:'icon-upload',plain:true"  onclick="alert('上传的功能暂时被禁用')">上传</a><!-- data-cmd="upload"  -->
...
<%----%>
<!--重命名dialog-->
<div id="dialog_netdisk" class="easyui-dialog" closed="true" data-options="top:100,width:300,height:150,draggable:true,buttons:'#bb'">
