...
<div id="customer_datagrid_btn">
    <div>
        ...
        <c:if test="${myFn:checkPermission('com._520it.crm.web.controller.CustomerController:all')}">
...
<div id="customer_dialog">
    <form id="customer_dialog_form" method="post">
        ...
        <table align="center">
            <tr>
                <td>用户名</td>
                <td><input class="easyui-validatebox" data-options="required:true,validType:'length[3,10]'" name="name"/></td>
                <td>年龄</td>
