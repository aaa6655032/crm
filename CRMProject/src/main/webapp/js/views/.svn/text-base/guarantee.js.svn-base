$(function(){
	...
	$("#guarantee_datagrid").datagrid({
		...
		columns:[
		         [
		          {field:'sn',title:'保修单号',width:1},
		          {field:'productname',title:'产品名称',width:1},
		          {field:'customer',title:'保修客户',width:1,formatter:customerFormatter}, 
		          {field:'duetime',title:'质保到期时间',width:1},
