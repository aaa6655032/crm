...
public class FileUtil {
    ...
    public static String upload(MultipartFile multipartFile){
        ...
        try {
            ...
            String realpath= UserContext.getLocalRequest().getSession().getServletContext().getRealPath("/netdisk");
    ...
    public static String mkdir(String parentPath) {
        ...
        try {
            ...
            if(parentPath==null){
                parentPath="/netdisk";
                absParentPath= UserContext.getLocalRequest().getSession().getServletContext().getRealPath("/netdisk");
            }
            absParentPath= UserContext.getLocalRequest().getSession().getServletContext().getRealPath(parentPath);
    ...
    public static InputStream getDownloadStream(String path) {
        ...
        System.out.println(UserContext.getLocalRequest().getSession().getServletContext().getRealPath("/netdisk"));
        String absParentPath= UserContext.getLocalRequest().getSession().getServletContext().getRealPath(path);
